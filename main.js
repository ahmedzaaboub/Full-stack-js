...
/*
    ...
    */
    function substringBetweenMatches(str, subStr) {
    	var long = subStr.length;
    	var valeur1 = str.indexOf(subStr);
    	var valeur2 = str.lastIndexOf(subStr);
    	return (str.slice(valeur1+long,valeur2));
    }
...
/*
	...
	*/
	function both_ends(count) {
		...
		if (count.length<2)
			return '';
		var arg1 = count.slice( 0,2);
		var arg2 = count.slice( -2);
...
/*
	...
	*/
	function mix_up(a, b) {
		...
		var mot1 = b.slice(0,2);
		var mot2 = a.slice(2);
		var mot3 = mot1 + mot2;
		var mot4 = a.slice(0,2);
		var mot5 = b.slice(2);
		var mot6 = mot4 + mot5 ;
	 ...
	 */
	 function front_back(str1, str2) {
	 	...
	 	if (str1.length%2==0){
	 		...
	 		str1front = str1.slice(0,Math.ceil(str1.length/2));
	 		str1back = str1.slice(Math.ceil(str1.length/2));
	 	}
	 	if (str2.length%2==0){
	 		...
	 		str2front = str2.slice(0,Math.ceil(str2.length/2));
	 		str2back = str2.slice(Math.ceil(str2.length/2));
	 	}
